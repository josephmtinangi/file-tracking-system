<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <div class="list-group">
      ...
      <a href="{{ url('/permissions') }}" class="list-group-item">Permissions</a>
      <a href="{{ url('/users') }}" @if(Request::is('users')) class="list-group-item active" @endif class="list-group-item">Users</a>
	</div>
  </div>
</div>
